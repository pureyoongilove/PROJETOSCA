...
div.alert {
  ...
  <div class='alert alert-success'>				
	<strong>Aluno cadastrado com sucesso!</strong> O que deseja fazer agora?
  </div>
  </div>
  ...
  <div align='center'> 
      ...
      <a href='cadAluno.php'><button type='button' class='btn btn-secondary btn-xs'> Cadastrar novo aluno <img src='img/adduser_icon.png' alt='Academia' width='30'></button></a>	    
  </div>	
